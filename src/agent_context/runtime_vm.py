...
def runtime_file_contract(root: Path, session_id: str, stages: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "runtime_review_client_dir": str(session_dir / "review_client"),
        "runtime_review_client_manifest_json_path": str(session_dir / "review_client" / "review_client_manifest.json"),
        "runtime_review_client_html_path": str(session_dir / "review_client" / "doctor-runtime-review-client.html"),
        "runtime_review_launch_json_path": str(session_dir / "review_client" / "review_launch.json"),
        "runtime_review_launch_md_path": str(session_dir / "review_client" / "review_launch.md"),
...
def render_session_markdown(session: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Runtime review client: `{session['files']['runtime_review_client_html_path']}`",
        f"- Runtime review launch: `{session['files']['runtime_review_launch_md_path']}`",
        "",
        "## Stages",
        "",
    ]
